...
def main() -> int:
    ...
    parser.add_argument("--url", required=True, help="Target URL in the target auth scope")
    parser.add_argument("--tag", default=None, help="Unique account_pool tag")
    parser.add_argument("--username", default=None, help="Explicit local account selector")
